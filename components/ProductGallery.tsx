...
const galleryItems = [
  ...
  {
    src: assets.doypackWhite,
    width: 1448,
    height: 1086,
    label: "EL PACK",
    caption: "2 pares. 0 dramas.",
    alt: "Packaging blanco de Sockets, frente y dorso, con medias adentro",
  },
  {
    src: assets.lifestyleCalle,
    width: 1122,
    height: 1402,
    label: "EN MOVIMIENTO",
    caption: "Van a donde vayas. Juntas.",
    alt: "Persona caminando por la ciudad con medias Sockets negras",
  },
  {
    src: assets.lifestyleSillon,
    width: 1122,
    height: 1402,
    label: "EN CASA",
    caption: "Domingo, café y par completo.",
    alt: "Persona tomando café en un sillón con medias Sockets blancas",
  },
  {
    src: assets.lifestyleCrew,
    width: 1122,
    height: 1402,
    label: "EL DETALLE",
    caption: "Escudo bordado, no estampado.",
    alt: "Primer plano de medias Sockets blancas con el logo bordado",
  },
] as const;
